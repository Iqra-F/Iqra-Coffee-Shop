        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                          <Image src={logo} width={80} alt='logo' height={80} className=''/>
                    ...
                    <a href="javascript:;"  className="py-2.5 px-5 h-9 block w-fit hover:text-black bg-black rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-white lg:mx-0">
                        Contact us
                    </a>
                </div>
                {/* <!--End Col--> */}
                <div className="lg:mx-auto text-left ">
                    <h4 className="text-lg text-gray-900 font-medium mb-7">Alowishus</h4>
            ...
            data-aos-duration="1500">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a className='text-black' href="https://Alowishus.io/">Iqra Fatima Webtise</a>, All rights reserved.</span>
                    <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        <a href="javascript:;"  className="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-gray-500">
